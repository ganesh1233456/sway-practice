...
/// General data structure containing information about campaign
pub struct CampaignInfo {
    /// The user who has created the campaign
    author: Identity,
    /// The user that this campaign accepts as a deposit
    asset: ContractId,
    ...
    target_amount: u64,
    /// The current amount pledge used to measure against the target_amount
    total_pledge: u64,
}
